...
ScriptGenerator.prototype.generateAspNetCoreDeploymentScript = function (_) {
  ...
  var msbuildArguments = '"%DEPLOYMENT_SOURCE%\\' + this.solutionPath + '" /nologo /verbosity:m /t:Build /p:AutoParameterizationWebConfigConnectionStrings=false;Configuration=Release;UseSharedCompilation=false';
  msbuildArguments += ' %SCM_BUILD_ARGS%';
