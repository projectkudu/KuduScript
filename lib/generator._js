...
function ScriptGenerator(repositoryRoot, projectType, projectPath, solutionPath, sitePath, scriptType, scriptOutputPath, noDotDeployment, noSolution, aspNet5Runtime, logger, confirmFunc) {
...
ScriptGenerator.prototype.generateKDeploymentScript = function (templateFileName, options, _) {
  ...
  var templateContent = getTemplatesContent([
    ...
    .replace(/{SCM_DNX_VERSION}/g, options.aspNet5Runtime);
