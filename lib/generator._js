...
function generateAngularDeploymentScript(scriptGenerator, _) {
  scriptGenerator.generateAngularDeploymentScript(_);
}
...
ScriptGenerator.prototype.generateAngularDeploymentScript = function (_) {
  log.info('Generating deployment script for Angular Web Site');

  this.generateBasicDeploymentScript('angular.template', _);
};
