...
function generateAspNetCoreMSBuild16DeploymentScript(scriptGenerator, _) {
  scriptGenerator.generateAspNetCoreMSBuild16DeploymentScript(_);
}

function generateAspNetCoreMSBuild1607DeploymentScript(scriptGenerator, _) {
  scriptGenerator.generateAspNetCoreMSBuild1607DeploymentScript(_);
}

function generateDotNetConsoleMSBuild16DeploymentScript(scriptGenerator, _) {
  scriptGenerator.generateDotNetConsoleMSBuild16DeploymentScript(_);
}

function generateDotNetConsoleMSBuild1607DeploymentScript(scriptGenerator, _) {
  scriptGenerator.generateDotNetConsoleMSBuild1607DeploymentScript(_);
}

function generateFunctionAppMSBuild16DeploymentScript(scriptGenerator, _) {
  scriptGenerator.generateFunctionAppMSBuild16DeploymentScript(_);
}

function generateFunctionAppMSBuild1607DeploymentScript(scriptGenerator, _) {
  scriptGenerator.generateFunctionAppMSBuild1607DeploymentScript(_);
}
...
ScriptGenerator.prototype.generateFunctionAppDeploymentScript = function (_) {
  ...
  if (this.projectPath) {
    ...
    if (this.solutionPath) { // nuget restore argument
      options.RestoreArguments = fixPathSeparatorToWindows(this.solutionPath);
    } else {
...
ScriptGenerator.prototype.generateFunctionAppMSBuild1607DeploymentScript = function (_) {
  ...
  options.projectPath = fixPathSeparatorToWindows(this.projectPath);
  this.generateFunctionAppScript('function.msbuild1607.template', options, _);
};

ScriptGenerator.prototype.generateFunctionAppMSBuild16DeploymentScript = function (_) {
  log.info('Generating deployment script for function MSBuild16 App');
  ...
  options.projectPath = fixPathSeparatorToWindows(this.projectPath);
  this.generateFunctionAppScript('function.msbuild16.template', options, _);
};
...
ScriptGenerator.prototype.generateAspNetCoreMSBuild16DeploymentScript = function (_) {
  log.info('Generating deployment script for ASP.NET MSBuild16 App');

  options = {}
  options.projectPath = fixPathSeparatorToWindows(this.projectPath);
  this.generateAspNetCoreMSBuild16AppScript('aspnet.core.msbuild16.template', options, _);
};

ScriptGenerator.prototype.generateAspNetCoreMSBuild1607DeploymentScript = function (_) {
  log.info('Generating deployment script for ASP.NET MSBuild16.7.0 App');

  options = {}
  options.projectPath = fixPathSeparatorToWindows(this.projectPath);
  this.generateAspNetCoreMSBuild16AppScript('aspnet.core.msbuild1607.template', options, _);
};
...
ScriptGenerator.prototype.generateDotNetConsoleMSBuild1607DeploymentScript = function (_) {
  argNotNull(this.projectPath, 'projectPath');
  ...
  this.generateDotNetDeploymentScript('dotnetconsole.msbuild1607.template', options, _);
};

ScriptGenerator.prototype.generateDotNetConsoleMSBuild16DeploymentScript = function (_) {
  argNotNull(this.projectPath, 'projectPath');
  ...
  this.generateDotNetDeploymentScript('dotnetconsole.msbuild16.template', options, _);
};
...
ScriptGenerator.prototype.generateAspNetCoreMSBuild16AppScript = function (templateFileName, options, _) {
  argNotNull(templateFileName, 'templateFileName');
