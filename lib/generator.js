...
ScriptGenerator.prototype.writeDeploymentFiles = function ScriptGenerator_prototype_writeDeploymentFiles__8(templateContent, _) { var deployScriptFileName, deploymentCommand, deployScriptPath, deploymentFilePath, __this = this; var __frame = { name: "ScriptGenerator_prototype_writeDeploymentFiles__8", line: 309 }; return __func(_, this, arguments, ScriptGenerator_prototype_writeDeploymentFiles__8, 1, __frame, function __$ScriptGenerator_prototype_writeDeploymentFiles__8() {
    ...
    return writeContentToFile(deployScriptPath, templateContent, __cb(_, __frame, 18, 2, function __$ScriptGenerator_prototype_writeDeploymentFiles__8() { return (function __$ScriptGenerator_prototype_writeDeploymentFiles__8(__then) {

        if (!__this.noDotDeployment) {

          return writeContentToFile(deploymentFilePath, ("[config]\ncommand = " + deploymentCommand), __cb(_, __frame, 22, 4, __then, true)); } else { __then(); } ; })(function __$ScriptGenerator_prototype_writeDeploymentFiles__8() {
...
function writeContentToFile(path, content, _) { var __frame = { name: "writeContentToFile", line: 345 }; return __func(_, this, arguments, writeContentToFile, 2, __frame, function __$writeContentToFile() { return (function __$writeContentToFile(__then) {
