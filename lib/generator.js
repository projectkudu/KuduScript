...
function generateGoDeploymentScript(scriptGenerator, _) { var __frame = { name: "generateGoDeploymentScript", line: 140 }; return __func(_, this, arguments, generateGoDeploymentScript, 1, __frame, function __$generateGoDeploymentScript() {
    return scriptGenerator.generateGoDeploymentScript(__cb(_, __frame, 1, 2, _, true)); });};


function generateAspNetCoreDeploymentScript(scriptGenerator, _) { var __frame = { name: "generateAspNetCoreDeploymentScript", line: 144 }; return __func(_, this, arguments, generateAspNetCoreDeploymentScript, 1, __frame, function __$generateAspNetCoreDeploymentScript() {
...
function generateDotNetCoreConsoleDeploymentScript(scriptGenerator, _) { var __frame = { name: "generateDotNetCoreConsoleDeploymentScript", line: 152 }; return __func(_, this, arguments, generateDotNetCoreConsoleDeploymentScript, 1, __frame, function __$generateDotNetCoreConsoleDeploymentScript() {
    return scriptGenerator.generateDotNetCoreConsoleDeploymentScript(__cb(_, __frame, 1, 2, _, true)); });};


function generateWapDeploymentScript(scriptGenerator, _) { var __frame = { name: "generateWapDeploymentScript", line: 156 }; return __func(_, this, arguments, generateWapDeploymentScript, 1, __frame, function __$generateWapDeploymentScript() {
    return scriptGenerator.generateWapDeploymentScript(__cb(_, __frame, 1, 2, _, true)); });};


function generateWebSiteDeploymentScript(scriptGenerator, _) { var __frame = { name: "generateWebSiteDeploymentScript", line: 160 }; return __func(_, this, arguments, generateWebSiteDeploymentScript, 1, __frame, function __$generateWebSiteDeploymentScript() {
    return scriptGenerator.generateWebSiteDeploymentScript(__cb(_, __frame, 1, 2, _, true)); });};


function generateNodeDeploymentScript(scriptGenerator, _) { var __frame = { name: "generateNodeDeploymentScript", line: 164 }; return __func(_, this, arguments, generateNodeDeploymentScript, 1, __frame, function __$generateNodeDeploymentScript() {
    return scriptGenerator.generateNodeDeploymentScript(__cb(_, __frame, 1, 2, _, true)); });};


function generatePythonDeploymentScript(scriptGenerator, _) { var __frame = { name: "generatePythonDeploymentScript", line: 168 }; return __func(_, this, arguments, generatePythonDeploymentScript, 1, __frame, function __$generatePythonDeploymentScript() {
    return scriptGenerator.generatePythonDeploymentScript(__cb(_, __frame, 1, 2, _, true)); });};


function generateRubyDeploymentScript(scriptGenerator, _) { var __frame = { name: "generateRubyDeploymentScript", line: 172 }; return __func(_, this, arguments, generateRubyDeploymentScript, 1, __frame, function __$generateRubyDeploymentScript() {
    return scriptGenerator.generateRubyDeploymentScript(__cb(_, __frame, 1, 2, _, true)); });};


function generatePHPDeploymentScript(scriptGenerator, _) { var __frame = { name: "generatePHPDeploymentScript", line: 176 }; return __func(_, this, arguments, generatePHPDeploymentScript, 1, __frame, function __$generatePHPDeploymentScript() {
    return scriptGenerator.generatePHPDeploymentScript(__cb(_, __frame, 1, 2, _, true)); });};


function generateBasicWebSiteDeploymentScript(scriptGenerator, _) { var __frame = { name: "generateBasicWebSiteDeploymentScript", line: 180 }; return __func(_, this, arguments, generateBasicWebSiteDeploymentScript, 1, __frame, function __$generateBasicWebSiteDeploymentScript() {
...
function generateFunctionAppDeploymentScript(scriptGenerator, _) { var __frame = { name: "generateFunctionAppDeploymentScript", line: 187 }; return __func(_, this, arguments, generateFunctionAppDeploymentScript, 1, __frame, function __$generateFunctionAppDeploymentScript() {
    return scriptGenerator.generateFunctionAppDeploymentScript(__cb(_, __frame, 1, 2, _, true)); });};


function generateDotNetCoreFunctionAppDeploymentScript(scriptGenerator, _) { var __frame = { name: "generateDotNetCoreFunctionAppDeploymentScript", line: 191 }; return __func(_, this, arguments, generateDotNetCoreFunctionAppDeploymentScript, 1, __frame, function __$generateDotNetCoreFunctionAppDeploymentScript() {
    return scriptGenerator.generateDotNetCoreFunctionAppDeploymentScript(__cb(_, __frame, 1, 2, _, true)); });};


ScriptGenerator.prototype.generateDeploymentScript = function ScriptGenerator_prototype_generateDeploymentScript__1(_) { var generator, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDeploymentScript__1", line: 195 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDeploymentScript__1, 0, __frame, function __$ScriptGenerator_prototype_generateDeploymentScript__1() {
...
ScriptGenerator.prototype.generateGoDeploymentScript = function ScriptGenerator_prototype_generateGoDeploymentScript__2(_) { var __this = this; var __frame = { name: "ScriptGenerator_prototype_generateGoDeploymentScript__2", line: 214 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateGoDeploymentScript__2, 0, __frame, function __$ScriptGenerator_prototype_generateGoDeploymentScript__2() {
...
ScriptGenerator.prototype.generatePythonDeploymentScript = function ScriptGenerator_prototype_generatePythonDeploymentScript__5(_) { var __this = this; var __frame = { name: "ScriptGenerator_prototype_generatePythonDeploymentScript__5", line: 254 }; return __func(_, this, arguments, ScriptGenerator_prototype_generatePythonDeploymentScript__5, 0, __frame, function __$ScriptGenerator_prototype_generatePythonDeploymentScript__5() {
...
ScriptGenerator.prototype.generateRubyDeploymentScript = function ScriptGenerator_prototype_generateRubyDeploymentScript__6(_) { var __this = this; var __frame = { name: "ScriptGenerator_prototype_generateRubyDeploymentScript__6", line: 260 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateRubyDeploymentScript__6, 0, __frame, function __$ScriptGenerator_prototype_generateRubyDeploymentScript__6() {
...
ScriptGenerator.prototype.generatePHPDeploymentScript = function ScriptGenerator_prototype_generatePHPDeploymentScript__7(_) { var __this = this; var __frame = { name: "ScriptGenerator_prototype_generatePHPDeploymentScript__7", line: 266 }; return __func(_, this, arguments, ScriptGenerator_prototype_generatePHPDeploymentScript__7, 0, __frame, function __$ScriptGenerator_prototype_generatePHPDeploymentScript__7() {
...
ScriptGenerator.prototype.generateWapDeploymentScript = function ScriptGenerator_prototype_generateWapDeploymentScript__8(_) { var msbuildArguments, msbuildArgumentsForInPlace, solutionDir, solutionArgs, options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateWapDeploymentScript__8", line: 272 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateWapDeploymentScript__8, 0, __frame, function __$ScriptGenerator_prototype_generateWapDeploymentScript__8() {
...
ScriptGenerator.prototype.generateDotNetCoreConsoleDeploymentScript = function ScriptGenerator_prototype_generateDotNetCoreConsoleDeploymentScript__10(_) { var options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDotNetCoreConsoleDeploymentScript__10", line: 335 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDotNetCoreConsoleDeploymentScript__10, 0, __frame, function __$ScriptGenerator_prototype_generateDotNetCoreConsoleDeploymentScript__10() {
    argNotNull(__this.absoluteProjectPath, "absoluteProjectPath");
    ...
    return __this.generateDotNetCoreScript("console.netcore.template", options, __cb(_, __frame, 9, 2, _, true)); });};


ScriptGenerator.prototype.generateDotNetCoreFunctionAppDeploymentScript = function ScriptGenerator_prototype_generateDotNetCoreFunctionAppDeploymentScript__11(_) { var options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDotNetCoreFunctionAppDeploymentScript__11", line: 347 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDotNetCoreFunctionAppDeploymentScript__11, 0, __frame, function __$ScriptGenerator_prototype_generateDotNetCoreFunctionAppDeploymentScript__11() {
    argNotNull(__this.absoluteProjectPath, "absoluteProjectPath");
    ...
    return __this.generateDotNetCoreScript("function.netcore.template", options, __cb(_, __frame, 9, 2, _, true)); });};


ScriptGenerator.prototype.generateDotNetConsoleDeploymentScript = function ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__12(_) { var msbuildArguments, solutionDir, solutionArgs, options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__12", line: 359 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__12, 0, __frame, function __$ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__12() {
    argNotNull(__this.projectPath, "projectPath");
...
ScriptGenerator.prototype.generateWebSiteDeploymentScript = function ScriptGenerator_prototype_generateWebSiteDeploymentScript__13(_) { var msbuildArguments, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateWebSiteDeploymentScript__13", line: 404 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateWebSiteDeploymentScript__13, 0, __frame, function __$ScriptGenerator_prototype_generateWebSiteDeploymentScript__13() { return (function __$ScriptGenerator_prototype_generateWebSiteDeploymentScript__13(__then) {
      if (__this.solutionPath) {
...
ScriptGenerator.prototype.generateBasicDeploymentScript = function ScriptGenerator_prototype_generateBasicDeploymentScript__14(templateFileName, _) { var lowerCaseScriptType, fixedSitePath, templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateBasicDeploymentScript__14", line: 429 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateBasicDeploymentScript__14, 1, __frame, function __$ScriptGenerator_prototype_generateBasicDeploymentScript__14() {
...
ScriptGenerator.prototype.generateFunctionAppScript = function ScriptGenerator_prototype_generateFunctionAppScript__15(templateFileName, options, _) { var lowerCaseScriptType, templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateFunctionAppScript__15", line: 443 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateFunctionAppScript__15, 2, __frame, function __$ScriptGenerator_prototype_generateFunctionAppScript__15() {
    argNotNull(templateFileName, "templateFileName");
...
ScriptGenerator.prototype.generateDotNetDeploymentScript = function ScriptGenerator_prototype_generateDotNetDeploymentScript__16(templateFileName, options, _) { var lowerCaseScriptType, solutionDir, templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDotNetDeploymentScript__16", line: 458 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDotNetDeploymentScript__16, 2, __frame, function __$ScriptGenerator_prototype_generateDotNetDeploymentScript__16() {
    argNotNull(templateFileName, "templateFileName");
...
ScriptGenerator.prototype.generateDotNetCoreScript = function ScriptGenerator_prototype_generateDotNetCoreScript__17(templateFileName, options, _) { var prop, lowerCaseScriptType, templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDotNetCoreScript__17", line: 478 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDotNetCoreScript__17, 2, __frame, function __$ScriptGenerator_prototype_generateDotNetCoreScript__17() {
    argNotNull(templateFileName, "templateFileName");
    ...
    templateContent = getTemplatesContent([(("deploy." + lowerCaseScriptType) + ".prefix.template"),((("deploy." + lowerCaseScriptType) + ".") + templateFileName),(("deploy." + lowerCaseScriptType) + ".postfix.template"),]).replace(/{DotnetpublishArguments}/g, options.DotnetpublishArguments).replace(/{RestoreArguments}/g, options.RestoreArguments);

    return __this.writeDeploymentFiles(templateContent, __cb(_, __frame, 21, 2, _, true)); });};


ScriptGenerator.prototype.generateAspNetCoreScript = function ScriptGenerator_prototype_generateAspNetCoreScript__18(templateFileName, options, _) { var prop, lowerCaseScriptType, templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateAspNetCoreScript__18", line: 502 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateAspNetCoreScript__18, 2, __frame, function __$ScriptGenerator_prototype_generateAspNetCoreScript__18() {
    argNotNull(templateFileName, "templateFileName");
...
ScriptGenerator.prototype.writeDeploymentFiles = function ScriptGenerator_prototype_writeDeploymentFiles__19(templateContent, _) { var deployScriptFileName, deploymentCommand, deployScriptPath, deploymentFilePath, __this = this; var __frame = { name: "ScriptGenerator_prototype_writeDeploymentFiles__19", line: 555 }; return __func(_, this, arguments, ScriptGenerator_prototype_writeDeploymentFiles__19, 1, __frame, function __$ScriptGenerator_prototype_writeDeploymentFiles__19() {
    ...
    return writeContentToFile(deployScriptPath, templateContent, __cb(_, __frame, 23, 2, function __$ScriptGenerator_prototype_writeDeploymentFiles__19() { return (function __$ScriptGenerator_prototype_writeDeploymentFiles__19(__then) {

        if (!__this.noDotDeployment) {

          return writeContentToFile(deploymentFilePath, ("[config]\ncommand = " + deploymentCommand), __cb(_, __frame, 27, 4, __then, true)); } else { __then(); } ; })(function __$ScriptGenerator_prototype_writeDeploymentFiles__19() {
...
function writeContentToFile(path, content, _) { var __frame = { name: "writeContentToFile", line: 596 }; return __func(_, this, arguments, writeContentToFile, 2, __frame, function __$writeContentToFile() { return (function __$writeContentToFile(__then) {
