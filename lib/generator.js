...
ScriptGenerator.prototype.generateWapDeploymentScript = function ScriptGenerator_prototype_generateWapDeploymentScript__3(_) { var msbuildArguments, solutionDir, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateWapDeploymentScript__3", line: 163 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateWapDeploymentScript__3, 0, __frame, function __$ScriptGenerator_prototype_generateWapDeploymentScript__3() {
    ...
    return __this.generateDotNetDeploymentScript("deploy.batch.aspnet.wap.template", msbuildArguments, __cb(_, __frame, 22, 2, _, true)); });};


ScriptGenerator.prototype.generateWebSiteDeploymentScript = function ScriptGenerator_prototype_generateWebSiteDeploymentScript__4(_) { var msbuildArguments, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateWebSiteDeploymentScript__4", line: 188 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateWebSiteDeploymentScript__4, 0, __frame, function __$ScriptGenerator_prototype_generateWebSiteDeploymentScript__4() { return (function __$ScriptGenerator_prototype_generateWebSiteDeploymentScript__4(__then) {
      if (__this.solutionPath) {
...
ScriptGenerator.prototype.generateBasicDeploymentScript = function ScriptGenerator_prototype_generateBasicDeploymentScript__5(templateFileName, _) { var lowerCaseScriptType, fixedSitePath, templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateBasicDeploymentScript__5", line: 206 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateBasicDeploymentScript__5, 1, __frame, function __$ScriptGenerator_prototype_generateBasicDeploymentScript__5() {
...
ScriptGenerator.prototype.generateDotNetDeploymentScript = function ScriptGenerator_prototype_generateDotNetDeploymentScript__6(templateFileName, msbuildArguments, _) { var templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDotNetDeploymentScript__6", line: 220 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDotNetDeploymentScript__6, 2, __frame, function __$ScriptGenerator_prototype_generateDotNetDeploymentScript__6() {
    argNotNull(templateFileName, "templateFileName");
    ...
    templateContent = getTemplatesContent(["deploy.batch.prefix.template","deploy.batch.aspnet.template",templateFileName,"deploy.batch.postfix.template",]).replace(/{MSBuildArguments}/g, msbuildArguments).replace(/{SitePath}/g, fixPathSeperatorToWindows(__this.sitePath));
...
function writeContentToFile(path, content, _) { var __frame = { name: "writeContentToFile", line: 287 }; return __func(_, this, arguments, writeContentToFile, 2, __frame, function __$writeContentToFile() { return (function __$writeContentToFile(__then) {
