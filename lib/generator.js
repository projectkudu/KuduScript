...
ScriptGenerator.prototype.generateAspNetCoreDeploymentScript = function ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__9(_) { var options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__9", line: 297 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__9, 0, __frame, function __$ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__9() {
    ...
    options = { RestoreArguments: (((__this.solutionPath) ? __this.solutionPath : __this.projectPath)) }; return (function __$ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__9(__then) {
      if (__this.projectPath.endsWith("project.json")) {



        options.DotnetpublishArguments = __this.projectPath;
        return __this.generateAspNetCoreScript("aspnet.core.template", options, __cb(_, __frame, 16, 6, __then, true)); } else { return (function __$ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__9(__then) {
          if (__this.projectPath.endsWith(".xproj")) {


            options.MSBuildArguments = options.RestoreArguments;
            options.MSPublishArguments = __this.projectPath;
            return __this.generateAspNetCoreScript("aspnet.core.msbuild14.template", options, __cb(_, __frame, 22, 6, __then, true)); } else {



            options.MSBuildArguments = __this.projectPath;
            return __this.generateAspNetCoreScript("aspnet.core.msbuild15.template", options, __cb(_, __frame, 27, 6, __then, true)); } ; })(__then); } ; })(_); });};



ScriptGenerator.prototype.generateDnxConsoleAppDeploymentScript = function ScriptGenerator_prototype_generateDnxConsoleAppDeploymentScript__10(_) { var options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDnxConsoleAppDeploymentScript__10", line: 328 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDnxConsoleAppDeploymentScript__10, 0, __frame, function __$ScriptGenerator_prototype_generateDnxConsoleAppDeploymentScript__10() {
    if ((__this.scriptType != ScriptType.batch)) {
...
ScriptGenerator.prototype.generateWebSiteDeploymentScript = function ScriptGenerator_prototype_generateWebSiteDeploymentScript__12(_) { var msbuildArguments, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateWebSiteDeploymentScript__12", line: 387 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateWebSiteDeploymentScript__12, 0, __frame, function __$ScriptGenerator_prototype_generateWebSiteDeploymentScript__12() { return (function __$ScriptGenerator_prototype_generateWebSiteDeploymentScript__12(__then) {
      if (__this.solutionPath) {
...
ScriptGenerator.prototype.generateBasicDeploymentScript = function ScriptGenerator_prototype_generateBasicDeploymentScript__13(templateFileName, _) { var lowerCaseScriptType, fixedSitePath, templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateBasicDeploymentScript__13", line: 412 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateBasicDeploymentScript__13, 1, __frame, function __$ScriptGenerator_prototype_generateBasicDeploymentScript__13() {
...
function writeContentToFile(path, content, _) { var __frame = { name: "writeContentToFile", line: 536 }; return __func(_, this, arguments, writeContentToFile, 2, __frame, function __$writeContentToFile() { return (function __$writeContentToFile(__then) {
