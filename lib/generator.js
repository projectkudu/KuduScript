...
ScriptGenerator.prototype.generateAspNetCoreDeploymentScript = function ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__6(_) { var msbuildArguments, options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__6", line: 261 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__6, 0, __frame, function __$ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__6() {
    ...
    options = {
      ...
      if (__this.solutionPath) {
        return __this.generateAspNetCoreScript("deploy.batch.aspnet.core.msbuild.template", options, __cb(_, __frame, 19, 4, __then, true)); } else {

        return __this.generateAspNetCoreScript("deploy.batch.aspnet.core.template", options, __cb(_, __frame, 21, 4, __then, true)); } ; })(_); });};



ScriptGenerator.prototype.generateDnxConsoleAppDeploymentScript = function ScriptGenerator_prototype_generateDnxConsoleAppDeploymentScript__7(_) { var options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDnxConsoleAppDeploymentScript__7", line: 286 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDnxConsoleAppDeploymentScript__7, 0, __frame, function __$ScriptGenerator_prototype_generateDnxConsoleAppDeploymentScript__7() {
    if ((__this.scriptType != ScriptType.batch)) {
...
ScriptGenerator.prototype.generateDotNetConsoleDeploymentScript = function ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__8(_) { var msbuildArguments, solutionDir, solutionArgs, options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__8", line: 300 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__8, 0, __frame, function __$ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__8() {
    argNotNull(__this.projectPath, "projectPath");
...
ScriptGenerator.prototype.generateWebSiteDeploymentScript = function ScriptGenerator_prototype_generateWebSiteDeploymentScript__9(_) { var msbuildArguments, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateWebSiteDeploymentScript__9", line: 345 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateWebSiteDeploymentScript__9, 0, __frame, function __$ScriptGenerator_prototype_generateWebSiteDeploymentScript__9() { return (function __$ScriptGenerator_prototype_generateWebSiteDeploymentScript__9(__then) {
      if (__this.solutionPath) {
...
ScriptGenerator.prototype.generateBasicDeploymentScript = function ScriptGenerator_prototype_generateBasicDeploymentScript__10(templateFileName, _) { var lowerCaseScriptType, fixedSitePath, templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateBasicDeploymentScript__10", line: 370 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateBasicDeploymentScript__10, 1, __frame, function __$ScriptGenerator_prototype_generateBasicDeploymentScript__10() {
...
ScriptGenerator.prototype.generateDotNetDeploymentScript = function ScriptGenerator_prototype_generateDotNetDeploymentScript__11(templateFileName, options, _) { var lowerCaseScriptType, solutionDir, templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDotNetDeploymentScript__11", line: 384 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDotNetDeploymentScript__11, 2, __frame, function __$ScriptGenerator_prototype_generateDotNetDeploymentScript__11() {
    argNotNull(templateFileName, "templateFileName");
...
ScriptGenerator.prototype.generateAspNetCoreScript = function ScriptGenerator_prototype_generateAspNetCoreScript__12(templateFileName, options, _) { var templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateAspNetCoreScript__12", line: 404 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateAspNetCoreScript__12, 2, __frame, function __$ScriptGenerator_prototype_generateAspNetCoreScript__12() {
    ...
    templateContent = getTemplatesContent(["deploy.batch.prefix.template","deploy.batch.aspnet.template",templateFileName,"deploy.batch.postfix.template",]).replace(/{PROJECT_JSON}/g, fixPathSeperatorToWindows(options.aspNetCoreProject)).replace(/{SolutionPath}/g, options.solutionPath).replace(/{MSBuildArguments}/g, options.msbuildArguments);
...
function writeContentToFile(path, content, _) { var __frame = { name: "writeContentToFile", line: 488 }; return __func(_, this, arguments, writeContentToFile, 2, __frame, function __$writeContentToFile() { return (function __$writeContentToFile(__then) {
