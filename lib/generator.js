...
ScriptGenerator.prototype.generateAspNetCoreDeploymentScript = function ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__7(_) { var files, webProjFiles, relativeXprojPath, msbuildArguments, dotnetpublishArguments, options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__7", line: 273 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__7, 0, __frame, function __$ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__7() {
    ...
    files = fs.readdirSync(__this.projectPath);
    webProjFiles = files.filter(function(file) {
      return file.endsWith(".xproj"); });

    if ((webProjFiles.length != 1)) {
      return _(new Error(((("Expecting one xproj files but found " + webProjFiles.length) + " under") + __this.projectPath))); } ;

    relativeXprojPath = path.relative(__this.repositoryRoot, path.join(__this.projectPath, webProjFiles[0]));
    ...
    options = {
      ...
      solutionPath: __this.solutionPath }; return (function __$ScriptGenerator_prototype_generateAspNetCoreDeploymentScript__7(__then) {


      if (__this.solutionPath) {
        return __this.generateAspNetCoreScript("aspnet.core.msbuild.template", options, __cb(_, __frame, 43, 4, __then, true)); } else {

        return __this.generateAspNetCoreScript("aspnet.core.template", options, __cb(_, __frame, 45, 4, __then, true)); } ; })(_); });};



ScriptGenerator.prototype.generateDnxConsoleAppDeploymentScript = function ScriptGenerator_prototype_generateDnxConsoleAppDeploymentScript__8(_) { var options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDnxConsoleAppDeploymentScript__8", line: 322 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDnxConsoleAppDeploymentScript__8, 0, __frame, function __$ScriptGenerator_prototype_generateDnxConsoleAppDeploymentScript__8() {
    if ((__this.scriptType != ScriptType.batch)) {
...
ScriptGenerator.prototype.generateDotNetConsoleDeploymentScript = function ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__9(_) { var msbuildArguments, solutionDir, solutionArgs, options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__9", line: 336 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__9, 0, __frame, function __$ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__9() {
    argNotNull(__this.projectPath, "projectPath");
...
function writeContentToFile(path, content, _) { var __frame = { name: "writeContentToFile", line: 526 }; return __func(_, this, arguments, writeContentToFile, 2, __frame, function __$writeContentToFile() { return (function __$writeContentToFile(__then) {
