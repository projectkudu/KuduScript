...
function generateConsoleDeploymentScript(scriptGenerator, _) { var __frame = { name: "generateConsoleDeploymentScript", line: 121 }; return __func(_, this, arguments, generateConsoleDeploymentScript, 1, __frame, function __$generateConsoleDeploymentScript() {
    return scriptGenerator.generateConsoleDeploymentScript(__cb(_, __frame, 1, 2, _, true)); });};
...
ScriptGenerator.prototype.generateConsoleDeploymentScript = function ScriptGenerator_prototype_generateConsoleDeploymentScript__4(_) { var msbuildArguments, solutionDir, solutionArgs, options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateConsoleDeploymentScript__4", line: 203 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateConsoleDeploymentScript__4, 0, __frame, function __$ScriptGenerator_prototype_generateConsoleDeploymentScript__4() {
    argNotNull(__this.projectPath, "projectPath");
...
function writeContentToFile(path, content, _) { var __frame = { name: "writeContentToFile", line: 340 }; return __func(_, this, arguments, writeContentToFile, 2, __frame, function __$writeContentToFile() { return (function __$writeContentToFile(__then) {
