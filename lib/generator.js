...
function generateProjectKDeploymentScript(scriptGenerator, _) { var __frame = { name: "generateProjectKDeploymentScript", line: 123 }; return __func(_, this, arguments, generateProjectKDeploymentScript, 1, __frame, function __$generateProjectKDeploymentScript() {
    return scriptGenerator.generateProjectKDeploymentScript(__cb(_, __frame, 1, 2, _, true)); });};


function generateDotNetConsoleDeploymentScript(scriptGenerator, _) { var __frame = { name: "generateDotNetConsoleDeploymentScript", line: 127 }; return __func(_, this, arguments, generateDotNetConsoleDeploymentScript, 1, __frame, function __$generateDotNetConsoleDeploymentScript() {
    return scriptGenerator.generateDotNetConsoleDeploymentScript(__cb(_, __frame, 1, 2, _, true)); });};


function generateWapDeploymentScript(scriptGenerator, _) { var __frame = { name: "generateWapDeploymentScript", line: 131 }; return __func(_, this, arguments, generateWapDeploymentScript, 1, __frame, function __$generateWapDeploymentScript() {
    return scriptGenerator.generateWapDeploymentScript(__cb(_, __frame, 1, 2, _, true)); });};


function generateWebSiteDeploymentScript(scriptGenerator, _) { var __frame = { name: "generateWebSiteDeploymentScript", line: 135 }; return __func(_, this, arguments, generateWebSiteDeploymentScript, 1, __frame, function __$generateWebSiteDeploymentScript() {
    return scriptGenerator.generateWebSiteDeploymentScript(__cb(_, __frame, 1, 2, _, true)); });};


function generateNodeDeploymentScript(scriptGenerator, _) { var __frame = { name: "generateNodeDeploymentScript", line: 139 }; return __func(_, this, arguments, generateNodeDeploymentScript, 1, __frame, function __$generateNodeDeploymentScript() {
    return scriptGenerator.generateNodeDeploymentScript(__cb(_, __frame, 1, 2, _, true)); });};


function generateBasicWebSiteDeploymentScript(scriptGenerator, _) { var __frame = { name: "generateBasicWebSiteDeploymentScript", line: 143 }; return __func(_, this, arguments, generateBasicWebSiteDeploymentScript, 1, __frame, function __$generateBasicWebSiteDeploymentScript() {
...
ScriptGenerator.prototype.generateDeploymentScript = function ScriptGenerator_prototype_generateDeploymentScript__1(_) { var generator, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDeploymentScript__1", line: 150 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDeploymentScript__1, 0, __frame, function __$ScriptGenerator_prototype_generateDeploymentScript__1() {
...
ScriptGenerator.prototype.generateNodeDeploymentScript = function ScriptGenerator_prototype_generateNodeDeploymentScript__2(_) { var __this = this; var __frame = { name: "ScriptGenerator_prototype_generateNodeDeploymentScript__2", line: 169 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateNodeDeploymentScript__2, 0, __frame, function __$ScriptGenerator_prototype_generateNodeDeploymentScript__2() {
...
ScriptGenerator.prototype.generateWapDeploymentScript = function ScriptGenerator_prototype_generateWapDeploymentScript__3(_) { var msbuildArguments, msbuildArgumentsForInPlace, solutionDir, solutionArgs, options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateWapDeploymentScript__3", line: 175 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateWapDeploymentScript__3, 0, __frame, function __$ScriptGenerator_prototype_generateWapDeploymentScript__3() {
...
ScriptGenerator.prototype.generateProjectKDeploymentScript = function ScriptGenerator_prototype_generateProjectKDeploymentScript__4(_) { var options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateProjectKDeploymentScript__4", line: 209 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateProjectKDeploymentScript__4, 0, __frame, function __$ScriptGenerator_prototype_generateProjectKDeploymentScript__4() {
    argNotNull(__this.projectPath, "projectPath");
...
ScriptGenerator.prototype.generateDotNetConsoleDeploymentScript = function ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__5(_) { var msbuildArguments, solutionDir, solutionArgs, options, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__5", line: 225 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__5, 0, __frame, function __$ScriptGenerator_prototype_generateDotNetConsoleDeploymentScript__5() {
    argNotNull(__this.projectPath, "projectPath");
...
ScriptGenerator.prototype.generateWebSiteDeploymentScript = function ScriptGenerator_prototype_generateWebSiteDeploymentScript__6(_) { var msbuildArguments, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateWebSiteDeploymentScript__6", line: 256 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateWebSiteDeploymentScript__6, 0, __frame, function __$ScriptGenerator_prototype_generateWebSiteDeploymentScript__6() { return (function __$ScriptGenerator_prototype_generateWebSiteDeploymentScript__6(__then) {
      if (__this.solutionPath) {
...
ScriptGenerator.prototype.generateBasicDeploymentScript = function ScriptGenerator_prototype_generateBasicDeploymentScript__7(templateFileName, _) { var lowerCaseScriptType, fixedSitePath, templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateBasicDeploymentScript__7", line: 274 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateBasicDeploymentScript__7, 1, __frame, function __$ScriptGenerator_prototype_generateBasicDeploymentScript__7() {
...
ScriptGenerator.prototype.generateDotNetDeploymentScript = function ScriptGenerator_prototype_generateDotNetDeploymentScript__8(templateFileName, options, _) { var solutionDir, templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateDotNetDeploymentScript__8", line: 288 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateDotNetDeploymentScript__8, 2, __frame, function __$ScriptGenerator_prototype_generateDotNetDeploymentScript__8() {
    argNotNull(templateFileName, "templateFileName");
...
ScriptGenerator.prototype.generateKDeploymentScript = function ScriptGenerator_prototype_generateKDeploymentScript__9(templateFileName, options, _) { var templateContent, __this = this; var __frame = { name: "ScriptGenerator_prototype_generateKDeploymentScript__9", line: 307 }; return __func(_, this, arguments, ScriptGenerator_prototype_generateKDeploymentScript__9, 2, __frame, function __$ScriptGenerator_prototype_generateKDeploymentScript__9() {
    argNotNull(templateFileName, "templateFileName");
...
ScriptGenerator.prototype.writeDeploymentFiles = function ScriptGenerator_prototype_writeDeploymentFiles__10(templateContent, _) { var deployScriptFileName, deploymentCommand, deployScriptPath, deploymentFilePath, __this = this; var __frame = { name: "ScriptGenerator_prototype_writeDeploymentFiles__10", line: 348 }; return __func(_, this, arguments, ScriptGenerator_prototype_writeDeploymentFiles__10, 1, __frame, function __$ScriptGenerator_prototype_writeDeploymentFiles__10() {
    ...
    return writeContentToFile(deployScriptPath, templateContent, __cb(_, __frame, 19, 2, function __$ScriptGenerator_prototype_writeDeploymentFiles__10() { return (function __$ScriptGenerator_prototype_writeDeploymentFiles__10(__then) {

        if (!__this.noDotDeployment) {

          return writeContentToFile(deploymentFilePath, ("[config]\ncommand = " + deploymentCommand), __cb(_, __frame, 23, 4, __then, true)); } else { __then(); } ; })(function __$ScriptGenerator_prototype_writeDeploymentFiles__10() {
...
function writeContentToFile(path, content, _) { var __frame = { name: "writeContentToFile", line: 385 }; return __func(_, this, arguments, writeContentToFile, 2, __frame, function __$writeContentToFile() { return (function __$writeContentToFile(__then) {
