...
function generateAngularDeploymentScript(scriptGenerator, _) {
    var __frame = { name: "generateAngularDeploymentScript", line: 156 };
    return __func(_, this, arguments, generateAngularDeploymentScript, 1, __frame,
        function __$generateAngularDeploymentScript() {
    return scriptGenerator.generateAngularDeploymentScript(__cb(_, __frame, 1, 2, _, true)); });};
...
ScriptGenerator.prototype.generateAngularDeploymentScript =
    function ScriptGenerator_prototype_generateAngularDeploymentScript__3(_) {
    var __this = this; var __frame = { name: "ScriptGenerator_prototype_generateAngularDeploymentScript__3",
            line: 208
    };
    return __func(_, this, arguments, ScriptGenerator_prototype_generateAngularDeploymentScript__3, 0, __frame,
        function __$ScriptGenerator_prototype_generateAngularDeploymentScript__3() {
    log.info("Generating deployment script for angular Web Site");

    return __this.generateBasicDeploymentScript("angular.template", __cb(_, __frame, 3, 2, _, true)); });};
